      ...
      <header className="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-24 pt-10 lg:grid-cols-[0.92fr_1.08fr]">
        <div>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <a href="#pricing" rel="noopener noreferrer" className="rounded-full bg-[#1F5FFF] px-7 py-4 font-bold text-white shadow-[0_16px_48px_rgba(14,17,22,0.08)] transition hover:-translate-y-0.5 hover:bg-[#1749CC] active:scale-[0.98]">Get Started</a>
