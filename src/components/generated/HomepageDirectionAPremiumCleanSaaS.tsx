      ...
      <header className="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-24 pt-10 lg:grid-cols-[0.92fr_1.08fr]">
        <div>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <a href="#pricing" className="rounded-full bg-[#1F5FFF] px-7 py-4 font-bold text-white shadow-[0_16px_48px_rgba(14,17,22,0.08)] transition hover:-translate-y-0.5 hover:bg-[#1749CC] active:scale-[0.98]">Get Started</a>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="relative overflow-hidden rounded-[36px] border border-[#17243A] bg-[#071120] px-6 py-16 text-center text-white shadow-[0_34px_110px_-70px_rgba(7,17,32,0.92)] md:px-10">
              ...
              <div className="relative mx-auto max-w-5xl">
                ...
                <a href="#pricing" className="mt-10 inline-block rounded-xl bg-[#1F5FFF] px-8 py-5 font-bold text-white shadow-[0_16px_46px_rgba(31,95,255,0.34)] transition hover:bg-[#1749CC] active:scale-[0.98]">Get Started <span className="ml-2">-&gt;</span></a>
